/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --env-file=/dev/null` (hash: cca634e3aa28545ff42a42b3d8639074)
...
interface __BaseEnv_Env {
  ...
  BROWSER: BrowserRun;
  APP_NAME: 'AAEasy';
  APP_URL: 'https://replace-me.example.com';
  ENVIRONMENT: 'production';
  PDF_LAUNCH_INTERVAL_MS: '20000';
  GROUP_ROOMS: DurableObjectNamespace<import('./worker/src/index').GroupRoom>;
  AUTH_LIMITER: DurableObjectNamespace<import('./worker/src/index').RateLimiter>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./worker/src/index');
    durableNamespaces: 'GroupRoom' | 'RateLimiter';
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'APP_NAME' | 'APP_URL' | 'ENVIRONMENT' | 'PDF_LAUNCH_INTERVAL_MS'>
  > {}
}
